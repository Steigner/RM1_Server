    ...
    $(".show").click(function() {
        ...
        if (counter == 1){
            ...
            $("#wrist_3_joint").click(function() {
                ...
                $("#wrist_2_joint, #wrist_1_joint, #elbow_joint, #shoulder_joint, #base_joint").css({"opacity": "0.4"});
                $("#label").text("Engine 6");
            });

            $("#wrist_2_joint").click(function() {
                $("#wrist_2_joint").css({"opacity": "1"});
                $("#wrist_3_joint, #wrist_1_joint, #elbow_joint, #shoulder_joint, #base_joint").css({"opacity": "0.4"});
                $("#label").text("Engine 5");
            });

            $("#wrist_1_joint").click(function() {
                $("#wrist_1_joint").css({"opacity": "1"});
                $("#wrist_3_joint, #wrist_2_joint, #elbow_joint, #shoulder_joint, #base_joint").css({"opacity": "0.4"});
                $("#label").text("Engine 4");
            });

            $("#elbow_joint").click(function() {
                $("#wrist_3_joint, #wrist_2_joint, #wrist_1_joint, #shoulder_joint, #base_joint").css({"opacity": "0.4"});
            ...
            $("#shoulder_joint").click(function() {
                ...
                $("#wrist_3_joint, #wrist_2_joint, #wrist_1_joint, #elbow_joint, #base_joint").css({"opacity": "0.4"});
                $("#label").text("Engine 2");
            });

            $("#base_joint").click(function() {
                $("#wrist_3_joint, #wrist_2_joint, #wrist_1_joint, #elbow_joint, #shoulder_joint").css({"opacity": "0.4"});
