    ...
    $('#depth_cam').click(function () {
        ...
        if (currentvalue == 'On_depth') {
            ...
            $.ajax({
                ...
                data: { value: 'stop_cam' },
                success: function (response) {
                    // if camera is not pluged in go home
                    if (response == 'Camera is not pluged-in!') {
                        insert_error_cookie(response);
                        window.location.href = '/home';
                    // eneable all functions
                    } else {
                        document.getElementById('depth_cam').value =
                            'Off_depth';
                        undisable();
                    }
                },
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response == 'Camera is not pluged-in!') {
                        ...
                        document.getElementById('color_cam').value =
                            'Off_color';
                        undisable();
                    }
                },
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response == 'Camera is not pluged-in!') {
                        ...
                        document.getElementById('infra_cam').value =
                            'Off_infra';
                        undisable();
                    }
                },
